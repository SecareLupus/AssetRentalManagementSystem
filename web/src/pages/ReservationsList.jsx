...
import { Calendar, Check, X, Clock, User, ArrowUpRight, Plus } from 'lucide-react';
...
const ReservationsList = () => {
    ...
    return (
        <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
            <PageHeader 
                title="Reservations & Approval" 
                subtitle="Review and manage equipment assignment requests."
                actions={
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                {loading ? (
                    ...
                    reservations.map(res => (
                        <GlassCard key={res.id} style={{ padding: '0', overflow: 'hidden' }}>
